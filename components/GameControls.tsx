...
import { GamePhase, Player, PlayerPieces, StoneType, Theme } from '../types';
...
const GameControls: React.FC<GameControlsProps> = ({
    ...
    hand, onCancelMove, theme, setTheme, showRoads, setShowRoads
}) => {
            ...
            <div className="p-4 rounded-lg order-4" style={{backgroundColor: theme.accentColor}}>
                ...
                <div className="space-y-2">
                    ...
                    <button 
                        ...
                        className={`w-full ${buttonBaseClasses}`} 
                        style={{ backgroundColor: showRoads ? theme.cellColor : theme.boardColor, color: theme.textColor }}
                    >
